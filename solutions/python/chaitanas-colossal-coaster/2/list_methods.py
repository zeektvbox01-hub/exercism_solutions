...
def add_me_to_the_queue(express_queue, normal_queue, ticket_type, person_name):
    ...
    Parameters:
        ...
        person_name (str): The name of the person to add to a queue.
...
def find_my_friend(queue, friend_name):
    ...
    Parameters:
        ...
        friend_name (str): The name of the friend to find.

    Returns:
        int: The index at which the friend's name was found.
    """
...
def add_me_with_my_friends(queue, index, person_name):
    ...
    Returns:
        list: The queue updated with the new name.
    """
...
def remove_the_mean_person(queue, person_name):
    ...
    Returns:
        list: The queue updated with the mean person's name removed.
    """
