...
def exchange_money(budget, exchange_rate):
    ...
    Returns the amount of the foreign currency received after applying the interest rate.
...
def get_change(budget, exchanging_value):
    ...
    Calculates the amount of money you have left after a exchange
...
def get_value_of_bills(denomination, number_of_bills):
    ...
    Calculates the amount of foreign money you get from an exchange
...
def get_number_of_bills(amount, denomination):
    ...
    Returns the number of bills you get after an exchange
...
def get_leftover_of_bills(amount, denomination):
    ...
    Returns the amount of money the booth keeps after an exchange
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    Variables:
        adjusted_exchange_rate(float): The rate taken as an exchange fee.
        exchanged_amount(float): The amount of foreign currency received after an exchange.
        number_of_bills(int): The number of bills received from an exchange
