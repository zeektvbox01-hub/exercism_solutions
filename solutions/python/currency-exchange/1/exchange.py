...
def get_leftover_of_bills(amount, denomination):
    ...
    returned from the starting amount, due to the currency denomination.
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    money_taken = exchange_rate * (spread/100) # 1.20 * (10/100) = 1.2 * 0.1 = 0.12
    true_exchange_rate = money_taken + exchange_rate # 1.2 + 0.12 = 1.32
    new_money = (budget/true_exchange_rate)//denomination * denomination
    return new_money