...
def get_change(budget, exchanging_value):
    ...
    Subtracts the amount of money you own from the money you want to exchange and returns the difference
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    money_taken = exchange_rate * (spread/100)
    true_exchange_rate = money_taken + exchange_rate
    return (budget/true_exchange_rate)//denomination * denomination