...
def is_blackjack(card_one, card_two):
    ...
    if card_one in {'J','K','Q','10'} or card_two in {'J','K','Q','10'}:
        if card_one == 'A' or card_two == 'A':
            return True
        return False
    return False   
...
def can_double_down(card_one, card_two):
    ...
    Returns:
        bool: Can the hand be doubled down? (i.e. totals 9, 10 or 11 points).
    """

    value_of_card_one = value_of_card(card_one)
    value_of_card_two = value_of_card(card_two)
    if value_of_card_one + value_of_card_two in {9,10,11}:
        return True
    return False   
