...
def preparation_time_in_minutes(number_of_layers):
    ...
    Multiplies the number of layers by the layer's preparation time, and returns the product
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    Adds the elapsed bake time to the number of layers multiplied by the layer's preparation time and returns the sum
    """
