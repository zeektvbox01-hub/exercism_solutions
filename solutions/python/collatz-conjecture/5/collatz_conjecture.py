...
def steps(number):
    ...
    The function starts by checking that the number is a positive integer greater than 0. It then defines the number
    as an integer, then does the Collatz Conjecture. If the number is even, you divide it by 2. If the number is odd,
    you multiply it by 3 and add 1. Repeat until you reach 1. The function then returns the steps it took to reach it.
    """
    loops = 0
